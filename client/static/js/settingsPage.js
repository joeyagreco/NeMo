...
function activateUpdateButtonIfValidInput() {
    ...
    if (pingsToSave > 0 && pingOnlineThreshold <= 100 && pingOnlineThreshold > 0 && pageRefreshFrequency > 0
        && pingCriticalRefreshFrequency > 0 && pingKnownRefreshFrequency > 0 && pingScanFrequency > 0) {
